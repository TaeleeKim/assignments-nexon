...
export class EventsController {
  ...
  async findAll(
    ...
    if (detailed) {
      return await this.eventsService.findAllDetailed(status, type);
    }
    return await this.eventsService.findAllSimple(status, type);
  }
  ...
  async update(@Param('id', MongoIdPipe) id: string, @Body() updateEventDto: Partial<CreateEventDto>) {
